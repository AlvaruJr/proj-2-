...
This is the readme for Netlogo.paraguay, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Netlogoparaguay) > Ok.
...
- To run the project find Netlogoparaguay.java (which will be in under src/main/java/netlogoparaguay) and right click > Run 'Netlogoparaguay'
